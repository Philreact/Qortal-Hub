...
describe('group-call router helpers', () => {
  ...
  it('tracks metrics snapshots', () => {
    ...
    tracker.setReticulumAudioQueueDepths({
      ...
      fd3DecodedAgeMsMax: 11.1114,
      decodedQueueDwellMsMax: 22.2224,
      rnsSendDurationMsMax: 33.3334,
      packetPathCheckMsMax: 44.4444,
      executorLoopGapMsMax: 55.5554,
      executorGapWhileQueuedMsMax: 66.6664,
      executorAudioPassMsMax: 77.7774,
      processBatchMsMax: 88.8884,
      processBatchFramesMax: 9,
      rnsSendSlowCount: 2,
    ...
    expect(tracker.getSnapshot()).toMatchObject({
      ...
      reticulumAudioFd3DecodedAgeMsMax: 11.111,
      reticulumAudioDecodedQueueDwellMsMax: 22.222,
      reticulumAudioRnsSendDurationMsMax: 33.333,
      reticulumAudioPacketPathCheckMsMax: 44.444,
      reticulumAudioExecutorLoopGapMsMax: 55.555,
      reticulumAudioExecutorGapWhileQueuedMsMax: 66.666,
      reticulumAudioExecutorAudioPassMsMax: 77.777,
      reticulumAudioProcessBatchMsMax: 88.888,
      reticulumAudioProcessBatchFramesMax: 9,
      reticulumAudioRnsSendSlowCount: 2,
      reticulumAudioExecutorStallCount: 3,
