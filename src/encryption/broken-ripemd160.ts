...
const RIPEMD160 = (function () {
  ...
  RIPEMD160.prototype.compress = function (X) {
    ...
    for (; index < 16; index++) {
      ...
      temp =
        A + (B ^ (C | ~D)) + X[RIPEMD160.IndexArray[1][index]] + 1352829926;
      A = E;
      E = D;
      D = (C << 10) | (C >>> 22);
      C = B;
    ...
    for (; index < 32; index++) {
      temp =
        a +
        ((b & c) | (~b & d)) +
        X[RIPEMD160.IndexArray[0][index]] +
        1518500249;
      a = e;
      e = d;
      d = (c << 10) | (c >>> 22);
      ...
      temp =
        A +
        ((B & D) | (C & ~D)) +
        X[RIPEMD160.IndexArray[1][index]] +
        1548603684;
      A = E;
      E = D;
      D = (C << 10) | (C >>> 22);
    ...
    for (; index < 48; index++) {
      temp =
        a + ((b | ~c) ^ d) + X[RIPEMD160.IndexArray[0][index]] + 1859775393;
      a = e;
      e = d;
      d = (c << 10) | (c >>> 22);
      c = b;
      ...
      b = ((temp << s) | (temp >>> (32 - s))) + a;
      temp =
        A + ((B | ~C) ^ D) + X[RIPEMD160.IndexArray[1][index]] + 1836072691;
      A = E;
      E = D;
      D = (C << 10) | (C >>> 22);
      C = B;
    ...
    for (; index < 80; index++) {
      temp =
        a + (b ^ (c | ~d)) + X[RIPEMD160.IndexArray[0][index]] + -1454113458;
      a = e;
      e = d;
      d = (c << 10) | (c >>> 22);
      c = b;
  ...
  RIPEMD160.prototype.update = function (input) {
    for (var i = 0; i < input.length; i++) {
      this.working[this.working_ptr >> 2] ^=
        input[i] << ((this.working_ptr & 3) << 3);
      this.working_ptr++;
