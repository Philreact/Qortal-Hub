...
const isReticulumMessageContinuation = (
  ...
  if (!previousMessage || !message || previousMessage?.divide || message?.divide) {
    return false;
  }
    ...
    if (reticulumChatEnabled && divideIndex === undefined) {
      ...
      if (divideIndex !== undefined) {
        ...
        scrollToIndexAfterMeasurements(
          index,
          'end',
          reticulumChatEnabled && !initialMsgs
            ? [50]
            : [50, 150, 350, 700]
        );
      }
    ...
    return messages.map((msg, index) => {
      ...
      try {
        if (message) {
          ...
          if (
            reticulumChatEnabled &&
            index === reticulumUnreadBoundaryIndex
          ) {
      ...
      >
        {initialUnreadPrompt && (
          ...
          >
            ...
            {initialUnreadPrompt.count === 1 ? '' : 's'}. See what you've missed...
          </Button>
        )}
        <Box
          ref={parentRef}
            ...
            reticulumChatEnabled
              ? {
                  ...
                  '&:hover': {
                    ...
                    '&::-webkit-scrollbar-thumb': {
                      backgroundColor: alpha(theme.palette.text.secondary, 0.52),
                      backgroundClip: 'padding-box',
                    },
                    '&::-webkit-scrollbar-thumb:hover': {
                      backgroundColor: alpha(theme.palette.text.secondary, 0.74),
                      backgroundClip: 'padding-box',
                    },
                  },
                }
