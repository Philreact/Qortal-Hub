...
import { nodeMenuItemSx, normalizeDashboardNodeUrl } from './utils';
...
export const InfoPreviewPanel = ({
  ...
  const { i18n } = useTranslation(['core', 'group', 'auth']);
  const resetKey = (i18n.resolvedLanguage || i18n.language || 'en').split(
    '-'
  )[0];
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Box component="span">{td('info_panel_status', 'status')}</Box>
                <Box
                  component="span"
                  aria-hidden="true"
                  sx={{
      ...
      <Menu
        ...
        PaperProps={{
          sx: {
            ...
            border: `1px solid ${alpha(theme.palette.border.subtle, 0.88)}`,
            borderRadius: '10px',
            boxShadow:
              theme.palette.mode === 'dark'
