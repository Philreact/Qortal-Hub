        ...
        >
          ...
          {!isCalmMode || onboardingPreviewLocked ? (
            <FeaturedExpandedPreview
              appName={
                onboardingPreviewLocked ? Q_CHAT_APP_NAME : expandedPreviewApp
              }
              theme={theme}
...
const AppTile = ({
  ...
  const tileButton = (
    <ButtonBase
      data-tour={isQChat ? 'hub-featured-qchat' : undefined}
      disableRipple
