...
describe('HomeFeaturedApps', () => {
  beforeEach(() => {
    ...
    document.body.removeAttribute(HUB_ONBOARDING_QCHAT_PREVIEW_LOCK_ATTRIBUTE);
  });
  ...
  it('keeps the onboarding Q-Chat preview open until the tour unlocks it', () => {
    vi.useFakeTimers();
    document.body.setAttribute(HUB_ONBOARDING_QCHAT_PREVIEW_LOCK_ATTRIBUTE, '');
    renderComponent();
    ...
    fireEvent.mouseLeave(
      openQChatButton.closest('[data-tour]') ?? openQChatButton
    );
    act(() => {
